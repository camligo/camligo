...
🌱 Currently, I’m working to improve my skills in Ruby on Rails, CSS, and JavaScript.

#### My bootcamp projects:

- **ReCloset**: a website inspired by Vinted
- **Swapt**: a mobile-first virtual wardrobe app where users can create outfits and swap clothing items
